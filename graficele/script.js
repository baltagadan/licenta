( function() {
  var data = {
    ...
    pieChart  : [
      {
        color       : 'red',
        description : 'из обшего количества продаж приходит на Северный рег.',
        title       : 'АЗС - РЕГИОН Север',
        value       : 0.38
      },
      {
        color       : 'blue',
        description : 'из обшего количества продаж приходит на Кишинев',
        title       : 'АЗС - РЕГИОН Кишинев',
        value       : 0.42
      },
      {
        color       : 'orange',
        description : 'из обшего количества продаж приходит на Южный рег.',
        title       : 'АЗС - РЕГИОН Юг',
        value       : 0.20
      }
    ]
  ...
  //setam tipul de date pe axa x
    var parse = d3.time.format( '%Y-%m-%d' ).parse;
    // manipularile cu data
  ...
  function drawPieChart( elementId, data ) {
    ...
    function drawDetailedInformation ( data, element ) {
      ...
      infoContainer.data( [ data.value * 100 ] )
                    ...
                    .attr( 'x', ( position === 'left' ? 12 : infoWidth ) )
                    .attr( 'y', 45 )
  ...
  // yeah, sper Bemolul sa aprecieze
  ಠ_ಠ();
